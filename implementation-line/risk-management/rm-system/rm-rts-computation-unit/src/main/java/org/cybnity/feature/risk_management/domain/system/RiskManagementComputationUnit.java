package org.cybnity.feature.risk_management.domain.system;
 ...
 */
public class RiskManagementComputationUnit extends AbstractVerticle {
	...
	public void start(Promise<Void> startPromise) throws Exception {
		...
		System.out.println("Risk Management computation unit is started");
